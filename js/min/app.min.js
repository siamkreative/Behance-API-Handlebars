...
$(function(){function e(){var e=JSON.parse(sessionStorage.getItem("behanceUser")),t=$("#profile-template").html(),a=Handlebars.compile(t),o=a(e);$("#header").html(o),$("#header .loading").remove()}function t(){var e=JSON.parse(sessionStorage.getItem("behanceProject")),t=$("#portfolio-template").html(),a=Handlebars.compile(t),o=a(e);$("#portfolio").html(o),$("#portfolio .loading").remove()}var a="your_behance_username",o="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",r="//www.behance.net/v2/users/"+a+"?callback=?&api_key="+o,s=12,n="//www.behance.net/v2/users/"+a+"/projects?callback=?&api_key="+o+"&per_page="+s;sessionStorage.getItem("behanceUser")?e():$.getJSON(r,function(t){sessionStorage.setItem("behanceUser",JSON.stringify(t)),e()}),sessionStorage.getItem("behanceProject")?t():$.getJSON(n,function(e){sessionStorage.setItem("behanceProject",JSON.stringify(e)),t()})});