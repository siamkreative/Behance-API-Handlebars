...
$(function(){function e(){var e=JSON.parse(sessionStorage.getItem("behanceUser")),t=$("#profile-template").html(),a=Handlebars.compile(t),s=a(e);$("#header").html(s)}function t(){var e=JSON.parse(sessionStorage.getItem("behanceProject")),t=$("#portfolio-template").html(),a=Handlebars.compile(t),s=a(e);$("#portfolio").html(s)}var a="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",s="behance_username",n="http://www.behance.net/v2/users/"+s+"?callback=?&api_key="+a,X=12,o="http://www.behance.net/v2/users/"+s+"/projects?callback=?&api_key="+a+"&per_page="+X;sessionStorage.getItem("behanceUser")?e():$.getJSON(n,function(t){sessionStorage.setItem("behanceUser",JSON.stringify(t)),e()}),sessionStorage.getItem("behanceProject")?t():$.getJSON(o,function(e){sessionStorage.setItem("behanceProject",JSON.stringify(e)),t()})});